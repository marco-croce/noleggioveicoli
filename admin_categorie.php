...
$body = new Template("skins/admin/dtml/categorie.html");
...
$categorie = $conn->query("SELECT id, nome, tariffa_oraria, tariffa_giornaliera, tariffa_mensile FROM categoria ORDER BY nome");
